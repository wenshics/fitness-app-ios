      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.features}>
            <FeatureRow icon="dumbbell.fill" text="16 exercises from beginner to advanced" />
            <FeatureRow icon="timer" text="Built-in timers for every workout" />
            <FeatureRow icon="list.bullet" text="Customize your own workout plan" />
            <FeatureRow icon="chart.bar.fill" text="Track your daily streak" />
          </View>
          ...
          <Text style={styles.disclaimer}>
            Sign in to save your progress and workout plans
          </Text>
        </View>
      </LinearGradient>
    </ScreenContainer>
